...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while curr.entrance is not None:
            if self.lower_bound <= cnt <= self.upper_bound and curr.bees != []:
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        while curr != None:
            if curr.ant != None :
                if curr.ant.have_double_damage == False:
                    curr.ant.double()
                #keep in mind that there can be more than one ant in a Place
                if curr.ant.is_container == True and curr.ant.ant_contained != None:
                    if curr.ant.ant_contained.have_double_damage == False:
